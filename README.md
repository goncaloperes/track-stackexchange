...
Add a free [Stack Apps key](https://stackapps.com/apps/oauth/register) as the `STACKEXCHANGE_KEY` repo secret. Without it the unauthenticated quota (300 requests/day per IP) throttles CI; the key raises it to 10,000/day.
...
| **Total** | **25,903** | **491** | **149** | **47** | **200** | **573** |
