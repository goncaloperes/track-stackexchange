...
|---|-------|-------|---------|----------|-------|------|------|
| 1 | 19 | 59,034 | 3 | ✓ | [ASP.NET Core 2.2: Unable to resolve service for type 'AutoMapper.IMapper'](https://stackoverflow.com/q/54239669) | `c#`, `asp.net-core`, `.net-core`, `asp.net-core-mvc` | 2019-01-17 |
...
| 6 | 3 | 1,055 | 2 | ✓ | [Angular app 6 in ASP.NET Core: More than one module matches](https://stackoverflow.com/q/54251659) | `angular`, `asp.net-core`, `angular6`, `angular-components` | 2019-01-18 |
| 7 | 3 | 3,856 | 1 | ✓ | [ECCODES ERROR when opening .GRIB file in Spyder](https://stackoverflow.com/q/62939533) | `python`, `anaconda`, `spyder`, `grib`, `eccodes` | 2020-07-16 |
