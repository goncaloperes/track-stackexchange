...
|---|-------|-------|---------|----------|-------|------|------|
| 1 | 19 | 59,028 | 3 | ✓ | [ASP.NET Core 2.2: Unable to resolve service for type 'AutoMapper.IMapper'](https://stackoverflow.com/q/54239669) | `c#`, `asp.net-core`, `.net-core`, `asp.net-core-mvc` | 2019-01-17 |
...
| 5 | 3 | 1,720 | 2 | ✓ | [Dynamic Badges GitHub](https://stackoverflow.com/q/49130448) | `git`, `github`, `badge`, `shields.io` | 2018-03-06 |
| 6 | 3 | 1,046 | 2 | ✓ | [Angular app 6 in ASP.NET Core: More than one module matches](https://stackoverflow.com/q/54251659) | `angular`, `asp.net-core`, `angular6`, `angular-components` | 2019-01-18 |
| 7 | 3 | 3,850 | 1 | ✓ | [ECCODES ERROR when opening .GRIB file in Spyder](https://stackoverflow.com/q/62939533) | `python`, `anaconda`, `spyder`, `grib`, `eccodes` | 2020-07-16 |
| 8 | 2 | 227 | 2 |  | [HTML5: Inclusion/Omission of closing in <input> or <p>](https://stackoverflow.com/q/52905841) | `html`, `tags`, `html-input` | 2018-10-20 |
...
| 10 | 2 | 165 | 1 | ✓ | [D3.Js require a file with a dynamic string path](https://stackoverflow.com/q/54310786) | `javascript`, `string`, `d3.js` | 2019-01-22 |
...
| 13 | 2 | 1,704 | 2 | ✓ | [Player disappears when it collides with a tagged object](https://stackoverflow.com/q/59184990) | `c#`, `unity-game-engine`, `scripting`, `collision` | 2019-12-04 |
...
| 15 | 2 | 262 | 2 | ✓ | [NetCDF get_dims too many values to unpack](https://stackoverflow.com/q/64559359) | `python`, `pandas`, `export-to-csv`, `netcdf`, `netcdf4` | 2020-10-27 |
| 16 | 2 | 745 | 1 | ✓ | [Remove default styles on ConvertKit form in WordPress](https://stackoverflow.com/q/66488990) | `css`, `wordpress`, `forms`, `plugins`, `widget` | 2021-03-05 |
...
| 20 | 1 | 594 | 2 | ✓ | [Import ARFF dataset using RWeka in RStudio (depencendy error: rJava)](https://stackoverflow.com/q/55692355) | `r`, `rstudio`, `data-mining`, `apriori`, `arff` | 2019-04-15 |
...
| 22 | 1 | 168 | 1 | ✓ | [DataFrame groupby hour and do the mean for a specific column](https://stackoverflow.com/q/64655923) | `python`, `pandas`, `dataframe`, `pandas-groupby`, `mean` | 2020-11-03 |
...
| 27 | 1 | 161 | 1 | ✓ | [Split dataframe string (when string can hold n values of that cell variable), into multiple columns](https://stackoverflow.com/q/71337157) | `python`, `pandas`, `string`, `dataframe`, `split` | 2022-03-03 |
| 28 | 0 | 223 | 1 | ✓ | [isin holidays only recognizing the first hour](https://stackoverflow.com/q/65689495) | `python`, `pandas`, `dataframe`, `isin`, `python-holidays` | 2021-01-12 |
| 29 | 0 | 56 | 1 | ✓ | [Grab and pass dict/JSON associated with string from list](https://stackoverflow.com/q/65836806) | `python`, `json`, `string`, `dictionary`, `printing` | 2021-01-21 |
...
| 31 | 0 | 785 | 1 | ✓ | [ggplot display Pareto front only for the points that belong to a specific level](https://stackoverflow.com/q/65999513) | `r`, `ggplot2`, `data-visualization`, `pareto-chart`, `pareto-optimality` | 2021-02-01 |
