...
|---|-------|-------|---------|----------|-------|------|------|
| 1 | 19 | 58,992 | 3 | ✓ | [ASP.NET Core 2.2: Unable to resolve service for type 'AutoMapper.IMapper'](https://stackoverflow.com/q/54239669) | `c#`, `asp.net-core`, `.net-core`, `asp.net-core-mvc` | 2019-01-17 |
| 2 | 5 | 1,420 | 2 | ✓ | [Split dataset per rows into smaller files in R](https://stackoverflow.com/q/57047338) | `r`, `import`, `split`, `dataset`, `bigdata` | 2019-07-15 |
| 3 | 5 | 2,365 | 2 | ✓ | [Unity3D playing sound when Player collides with an object with a specific tag](https://stackoverflow.com/q/59285897) | `c#`, `unity-game-engine`, `audio`, `collision` | 2019-12-11 |
...
| 5 | 3 | 1,716 | 2 | ✓ | [Dynamic Badges GitHub](https://stackoverflow.com/q/49130448) | `git`, `github`, `badge`, `shields.io` | 2018-03-06 |
| 6 | 3 | 1,036 | 2 | ✓ | [Angular app 6 in ASP.NET Core: More than one module matches](https://stackoverflow.com/q/54251659) | `angular`, `asp.net-core`, `angular6`, `angular-components` | 2019-01-18 |
| 7 | 3 | 3,837 | 1 | ✓ | [ECCODES ERROR when opening .GRIB file in Spyder](https://stackoverflow.com/q/62939533) | `python`, `anaconda`, `spyder`, `grib`, `eccodes` | 2020-07-16 |
...
| 16 | 2 | 737 | 1 | ✓ | [Remove default styles on ConvertKit form in WordPress](https://stackoverflow.com/q/66488990) | `css`, `wordpress`, `forms`, `plugins`, `widget` | 2021-03-05 |
...
| 20 | 1 | 591 | 2 | ✓ | [Import ARFF dataset using RWeka in RStudio (depencendy error: rJava)](https://stackoverflow.com/q/55692355) | `r`, `rstudio`, `data-mining`, `apriori`, `arff` | 2019-04-15 |
...
| 24 | 1 | 61 | 2 | ✓ | [Generate more than one date cells in each date_range](https://stackoverflow.com/q/65601635) | `python`, `pandas`, `dataframe`, `date`, `date-range` | 2021-01-06 |
| 25 | 1 | 509 | 1 | ✓ | [Append different strings to a list of strings depending on its position in the list](https://stackoverflow.com/q/65828594) | `python`, `string`, `list`, `loops`, `append` | 2021-01-21 |
...
| 29 | 0 | 53 | 1 | ✓ | [Grab and pass dict/JSON associated with string from list](https://stackoverflow.com/q/65836806) | `python`, `json`, `string`, `dictionary`, `printing` | 2021-01-21 |
...
| 31 | 0 | 783 | 1 | ✓ | [ggplot display Pareto front only for the points that belong to a specific level](https://stackoverflow.com/q/65999513) | `r`, `ggplot2`, `data-visualization`, `pareto-chart`, `pareto-optimality` | 2021-02-01 |
